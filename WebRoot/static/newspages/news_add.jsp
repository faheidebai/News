...
<div id="main">
  ...
  <div id="opt_area">
    ...
    <s:form action="" method="post" onsubmit="return check()">
      <p>        
        <s:select name="newsinfo.topic.id" label="主题" list="#session.topicList" 
        listKey="id" listValue="name" cssClass="opt_input" />
      </p>
      <p>
        <s:textfield label="标题" name="" cssClass="opt_input"  />
      </p>      
      <p>
        <s:textarea label="摘要" name="" cols="40" rows="3" />
      </p>
      <p>
         <s:textarea label="内容" name="t" cols="70" rows="10" /> 
